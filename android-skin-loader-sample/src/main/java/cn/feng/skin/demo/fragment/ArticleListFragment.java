...
import cn.feng.skin.demo.activity.util.CommonBaseAdapter;
import cn.feng.skin.demo.activity.util.CommonViewHolder;
...
public class ArticleListFragment extends Fragment {
	...
	public LayoutInflater onGetLayoutInflater(@Nullable Bundle savedInstanceState) {
		LayoutInflater li = super.onGetLayoutInflater(savedInstanceState);

		Log.d(TAG, "onGetLayoutInflater:" + li + ", factory:" + li.getFactory());
		return li;
	}
